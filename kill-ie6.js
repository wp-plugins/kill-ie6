if (document.all) {
	...
	if (ieVer < 7) {
		...
		document.write('#kill-ie6_oldBrowserWarning * {');
			document.write('font-family:verdana,arial,sans-serif;font-size:10px;');
		document.write('}');
		document.write('#kill-ie6_oldBrowserWarning {');
		...
		document.write('#kill-ie6_oldBrowserWarning a#kill-ie6_close {');
			document.write('color:#000;text-decoration:none;font-weight:bold;float:right;margin-right:5px;');
		document.write('}');
		...
		document.write('}');
		document.write('#kill-ie6_oldBrowserWarning #kill-ie6_text a {');
